...
from app.routers import auth, organizations,workflows,documents,policies,users
...
app.include_router(documents.router, prefix="/organizations/{org_id}/workflows/{workflow_id}/documents", tags=["Documents"])
