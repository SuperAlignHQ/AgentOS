...
@router.get("/", response_model=GetAuditLogsResponse, description="Get audit logs for an organisation")
async def get_audit_logs(
    ...
    authorize_user(user.role, org_member.role if org_member else None, TargetEnum.AUDIT, ActionTypeEnum.READ)
